...
<body>
		...
		<div class="row">
			<div class="text-center">
				<button class="btn btn-sm btn-danger" @click="categoryGetData(1)">믿고
					보는 맛집 리스트</button>
				<button class="btn btn-sm btn-info" @click="categoryGetData(2)">지역별
					맛집 리스트</button>
				<button class="btn btn-sm btn-success" @click="categoryGetData(3)">메뉴별
					맛집 리스트</button>
			</div>
		</div>
	...
	<script>
		new Vue({
			...
			// 생성자와 같은 역할 => 초기값 설정 (vue에서는 초기화면에 필요한 데이터 및 메소드 설정)
			mounted:function(){
