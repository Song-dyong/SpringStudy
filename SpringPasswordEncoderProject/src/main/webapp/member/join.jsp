		...
		<div class="row">
			<table class="table">
				...
				<tr>
					...
					<td width="80%">						 <!-- v-model => vue의 data에 값 자동 주입 -->
						<input type="text" ref="name" size=15 class="input-sm" v-model="name">
					</td>
				</tr>
				<tr>
					<td width="20%" class="text-right">성별</td>
					<td width="80%">						<!-- name은 그룹화
																ref는 속성값을 읽기 위함 -->
						<input type="radio" value="남자" ref="sex" v-model="sex">남자
						<input type="radio" value="여자" ref="sex" v-model="sex">여자
					</td>
				</tr>
				<tr>
					<td colspan="2" class="text-center">
						<input type="button" value="join" class="btn btn-sm btn-primary" @click="join()">
