		...
		<div class="row">
			<table class="table">
				<tr>
					...
					<td width="75%"><input type="text" ref="id" size=30
						class="input-sm" v-model="id"></td>
				</tr>
				<tr>
					<th width="25%" class="text-right">PWD</th>
					<td width="75%"><input type="password" ref="pwd" size=30
						class="input-sm" v-model="pwd"></td>
				</tr>
				<tr>
					<td colspan="2" class="text-center"><input type="button"
						value="login" class="btn btn-sm btn-danger" @click="login()">
						<a href="../member/join.do" class="btn btn-sm btn-primary">Join</a>
					</td>
				</tr>
			</table>
		</div>
