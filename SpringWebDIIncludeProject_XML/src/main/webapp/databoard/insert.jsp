...
$(function(){
	$('#addBtn').click(function(){
		$('#user-table > tbody').append(
			...
			+'<input type="button" value="취소" class="btn btn-xs btn-danger removeBtn'+fileIndex+'">' 
			+'</td>'
			+'</tr>'
		)
		fileIndex++;
	})
	$('.removeBtn'+fileIndex).click(function(){
		if(fileIndex>0){
	...
	<div class="row row1">
		...
		<table class="table">
			...
			<tr>
				<th width="15%" class="text-right success">제목</th>
				<td width="85%">
					<textarea rows="10" cols="50" name="content" class="input-sm"></textarea>
				</td> 
			</tr>
			<tr>
				<th width=15% class="text-right success">
				첨부 파일
				</th>
				<td width="85%">
					<table class="table">
						<tr>
							<td class="text-right">
								...
								class="btn btn-xs btn-success" id="addBtn">
							</td>
						</tr>
					</table>
