...
public class DataBoardRestController {
	...
	public String databoard_insert(DataBoardVO vo,HttpServletRequest request) {
		// /Users/dyongsong/Desktop/SpringDev/SpringStudy/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/SpringFinalProject/upload
		...
		if(list==null) {
			...
			//System.out.println("파일이 "+list.size()+"개 업로드 되었습니다.");
			String filename="";
			String filesize="";
	...
	public String databoard_list(int page) throws Exception {
		...
		map.put("start", start);
		map.put("end", end);
		List<DataBoardVO> list=dao.dataBoardList(map);
	...
	public String databoard_delete(int no, String pwd,HttpServletRequest request) throws Exception{
