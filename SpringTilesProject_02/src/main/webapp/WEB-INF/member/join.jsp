				...
				<form method="post" action="../member/join_ok.do" name="joinFrm"
					...
					<table class="table">
						<tr>
							...
							<td width=90% class="inline"><input type=text name=id id=id
								size=20 class="input-sm" readonly> <input type=button
								value="중복체크" class="btn btn-sm btn-success" id="idCheckBtn">
							</td>
						</tr>
						...
						<tr>
							...
							<td width=90% class="inline"><input type=text name=post
								id=post size=10 class="input-sm"> <input type=button
								value="우편번호검색" class="btn btn-sm btn-info" id="postBtn">
							</td>
						</tr>

						<tr>
							<th class="text-right" width=10%>주소</th>
							<td width=90% class="inline"><input type=text name=addr1
								id=addr1 size=55 class="input-sm" readonly></td>
						</tr>
