...
public class BoardController {
	...
	public String board_list(String page, Model model) {
		...
		// main_jsp의 경로 => 컨트롤러 자체에 매핑이 있다면 생략 가능
	...
	public String board_reply_ok(int pno, BoardVO vo) {
		...
		// redirect는 request(값 전송이 필요 없으므로..)
		return "redirect:../board/list.do";
	}
	...
	// 기본적으로 value가 생략, but! produces를 통해 문자 설정을 하면, value를 추가해야한다.
	// 기존의 responsebody의 한글깨짐 방지는 xml에서 설정
