		...
		<table class="table">
			<tr>
				<td>
					...
					<input type="button" class="btn btn-sm btn-success" value="입력"
						v-on:click="find()"
					>
				</td>
			</tr>
			...
			<table class="table">
				<thead>
					<tr class="danger">
						...
						<th class="text-center">MovieTitle</th>
		...
		new Vue(
				{
					...
					data : {
						movie : [
								{
									"startYearDate" : "2023.08.06",
									"endYearDate" : "2023.08.06",
									"startDate" : "2023년 08월 06일(일)",
									"endDate" : "2023년 08월 06일(일)",
									"movieCd" : "20218541",
									"showDt" : "20230806",
									"thumbUrl" : "/common/mast/movie/2023/06/thumb/thn_a68cc44d22d84acf9d861d5c931a4254.jpg",
									"movieNm" : "밀수",
									"movieNmEn" : "Smugglers",
								...
								},
								{
									...
									"movieCd" : "20193879",
									"showDt" : "20230806",
									"thumbUrl" : "/common/mast/movie/2023/08/thumb/thn_745a5d6e9bd24074b86285c230d3e109.jpg",
									"movieNm" : "비공식작전",
									"movieNmEn" : "Ransomed",
									"synop" : "실종된 동료를 구하기 위해 레바논으로 떠난 외교관 민준과 현지 택시기사 판수의 버디 액션 영화",
									"prdtYear" : "2022",
									"indieYn" : null,
									"artmovieYn" : null,
									"multmovieYn" : null,
								...
								},
								{
									...
									"movieCd" : "20232740",
									"showDt" : "20230806",
									"thumbUrl" : "/common/mast/movie/2023/07/thumb/thn_162c9770955d4b08b64cd926eb449e1d.jpg",
									"movieNm" : "바비",
									"movieNmEn" : "Barbie",
									"synop" : "원하는 무엇이든 될 수 있는 '바비랜드'에서 살아가던 '바비'가 현실 세계와 이어진 포털의 균열을 발견하게 되고, 이를 해결하기 위해 '켄'과 예기치 못한 여정을 떠나면서 펼쳐지는 이야기",
									"prdtYear" : "2023",
									"indieYn" : null,
									"artmovieYn" : null,
									"multmovieYn" : null,
								...
								},
								{
									...
									"movieCd" : "20219331",
									"showDt" : "20230806",
									"thumbUrl" : "/common/mast/movie/2023/05/thumb/thn_13a6f9eeac7d4d1a81600212e6c3e38d.jpg",
									"movieNm" : "여름날 우리",
									"movieNmEn" : "My Love",
									"synop" : "처음이었다, 사랑이 싹트는 기분\r\n\r\n너에게 풍덩 빠져버렸던 17살의 여름.\r\n너를 두고 아무것도 할 수 없었던 21살의 여름.\r\n그리고 몇 번의 여름이 지나고 다시 만난 너,\r\n이젠 놓치지 않을 거야.\r\n\r\n“널 만난 건 내 인생 최고의 행운이었어” ",
									"prdtYear" : "2021",
									"indieYn" : null,
									"artmovieYn" : null,
									"multmovieYn" : "Y",
					...
					mounted:function(){
						console.log("mounted: 가상메모리(가상돔)에 HTML이 올라간 상태...")
						// $(function(){}) , window.onload
						// 가상돔과 실제돔을 비교해서 변경 => diff (비교)
						// 가장 많이 사용되는 상태 (서버에서 데이터 읽어올 때)
					},
					beforeUpdate:function(){
						console.log("beforeUpdate: 상태가 변경(데이터값이 변경)되기 직전...")
						// 멤버변수 설정 :react => state, Vue => data 
						//	Vue의 data를 다른 메소드에서 변경시에는 this. 을 붙여야 한다. 
						// this. => Vue가 가지고 있는 멤버변수이므로, this. 필수
					},
					updated:function(){
						console.log("updated: 데이터 변경이나 수정이 완료된 상태 => mounted를 재호출")
					},
					beforeDestroy:function(){
						console.log("beforeDestroy: 메모리 해제 전...")
					},
					destroyed:function(){
						console.log("destroyed: 메모리 해제 완료")
					},
					// 사용자 정의 함수
					methods:{
						find:function(){
